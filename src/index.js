...
function hendelSubmit(e){
  e.preventDefault()
  const inputval= document.getElementById('email-input')
  console.log(inputval.value)
}

const HeplerTextStyle=()=>{
  return({
    color:'hsl(0, 100%, 63%)',
  })
}
  ...
  return (
    <article>
      ...
      <article className="article1">
        <div className="desk-wrapper wrapper">
          <IllustrationImages
      ...
      <article className="article2">
        <div className="desk-wrapper wrapper flex-reverse">
          <IllustrationImages
...
const BeforeFooter = () => {
  return (
    <div className=" wrapper before-footer">
  ...
  return (
    <>
      ...
      <img
        ...
        alt=""
        className="footer-img-desktop"
      />
      <footer>
        <div className=" footer news-letter wrapper desk-mob-wrapper">
          <h3 className="font-white">NEWSLETTER</h3>
          <p className="font-white">
            To recive tips on how to grow your community, sign up to our weekly
            newsletter. We'll never send you spam or pass on your email address
          </p>
          <form className="input" onSubmit={hendelSubmit}>
            <div>
            <input type="email" id='email-input' style={{border:`${border}`, borderColor:`${borderColor}`}}/>
            <div style={HeplerTextStyle()}>{helperText}</div>
            </div>
            <button type="submit" className="btn font-white">
              Subscribe
            </button>
          </form>
        </div>

        <div className="footer contact wrapper desk-mob-wrapper">
          ...
          <p className="font-white">
            ...
            autem quo ex quisquam iste modi repellendus atque culpa!
          </p>

          <div className="flex">
            <img src={images["icon-phone.svg"]} alt="" />
            <p className="font-white">Phone: +1-543-123-4567</p>
          </div>

          <div className="flex">
            <img src={images["icon-email.svg"]} alt="" />
            <p className="font-white">example@company.com</p>
          </div>
          <div className="flex social-logos">
            <svg
            ...
            <svg
              ...
              className="lucide lucide-instagram social-icons-strock"
            >
              <rect width="20" height="20" x="2" y="2" rx="5" ry="5" />
              <path
                className="social-icons-strock"
